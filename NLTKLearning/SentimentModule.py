...
# 加载之前保存的训练好的分类器模型
open_file = open("pickle_algos/naivebayes.pickle","rb")
...
open_file = open("pickle_algos/BernoulliNB_classifier.pickle","rb")
BernoulliNB_classifier = pickle.load(open_file)
open_file.close()

open_file = open("pickle_algos/LogisticRegression_classifier.pickle","rb")
LogisticRegression_classifier = pickle.load(open_file)
open_file.close()

open_file = open("pickle_algos/LinearSVC_classifier.pickle","rb")
LinearSVC_classifier = pickle.load(open_file)
open_file.close()

open_file = open("pickle_algos/SGDC_classifier.pickle","rb")
